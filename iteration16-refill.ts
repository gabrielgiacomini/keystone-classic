...
/**
 * Type aliases following the TypeScript Naming Convention (KS prefix)
 */

/**
 * Represents a Keystone Field Type Constructor.
 * @type KSFieldTypeConstructor
 */
type KSFieldTypeConstructor = FieldTypeConstructor;
// Suggested name: KeystoneFieldTypeConstructor (simpler and more maintainable)

/**
 * Options object used to define a field within a List.
 * @type KSFieldOptions
 */
type KSFieldOptions = FieldOptions;
// Suggested name: KeystoneFieldOptions (simpler and more maintainable)
 ...
 */
type KSField = Field;
// Suggested name: KeystoneField (simpler and more maintainable)

/**
 * Options for configuring a Keystone List.
 * @type KSListOptions
 */
type KSListOptions = ListOptions;
// Suggested name: KeystoneListOptions (simpler and more maintainable)
 ...
 */
type KSList = List;
// Suggested name: KeystoneList (simpler and more maintainable)

/**
 * Interface defining common KeystoneJS configuration options.
 * @type KSKeystoneOptions
 */
type KSKeystoneOptions = KeystoneOptions;
// Suggested name: KeystoneAppOptions (simpler and more maintainable)

/**
 * Represents a KeystoneJS v4 application instance.
 * @type KSKeystone
 */
type KSKeystone = Keystone;
// Suggested name: KeystoneApp (simpler and more maintainable)

// Field type-specific aliases
type KSTextField = TextField;
type KSNumberField = NumberField;
type KSTextareaField = TextareaField;
type KSBooleanField = BooleanField;
type KSSelectField = SelectField;
type KSDateField = DateField;
type KSDateTimeField = DateTimeField;
type KSHtmlField = HtmlField;
