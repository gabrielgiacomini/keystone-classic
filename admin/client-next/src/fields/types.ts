...
export type FieldMeta =
  ...
  | { fieldType: 'location'; label: string; path: string }
  ...
  | { fieldType: 'relationship'; label: string; path: string; refList: string; many?: boolean }
 ...
 *
 * @typeParam TValue The stored/submitted value type for this field.
 */
 ...
 *
 * @typeParam TFilterValue The filter expression value type for this field.
 */
 ...
 *
 * @typeParam TValue The value type stored at this field's path.
 */
 ...
 *
 * @typeParam TValue The stored/submitted value type for this field.
 * @typeParam TFilterValue The filter expression value type; defaults to `TValue`.
 */
