...
import Alert from '../../elemental/Alert/index.mjs';
import EditForm from './components/EditForm.mjs';
import EditFormHeader from './components/EditFormHeader.mjs';
import RelatedItemsList from './components/RelatedItemsList/RelatedItemsList.mjs';
				...
				return (
					<Container>
						<Alert color="danger" style={{ marginTop: '2em' }}>
							...
							<Link to={`${Keystone.adminLegacyPath}/${this.props.routeParams.listId}`}>
