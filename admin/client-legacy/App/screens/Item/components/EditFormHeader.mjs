...
import ToolbarSection from './Toolbar/ToolbarSection.mjs';
import EditFormHeaderSearch from './EditFormHeaderSearch.mjs';
...
export const EditFormHeader = React.createClass({
	...
	renderSearch () {
		...
		return (
			<form action={`${Keystone.adminLegacyPath}/${list.path}`} className="EditForm__header__search">
