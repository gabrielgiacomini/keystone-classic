...
import DragDrop from './RelatedItemsListDragDrop.mjs';
import ListRow from './RelatedItemsListRow.mjs';
	...
	render () {
		...
		return (
			<div className="Relationship">
				<h3 className="Relationship__link"><Link to={listHref}>{heading}</Link></h3>
