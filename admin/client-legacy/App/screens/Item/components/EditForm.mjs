...
import { Button, LoadingButton } from '../../../elemental/index.mjs';
import AlertMessages from '../../../shared/AlertMessages.mjs';
import ConfirmationDialog from '../../../shared/ConfirmationDialog.mjs';

import FormHeading from './FormHeading.mjs';
import AltText from './AltText.mjs';
import FooterBar from './FooterBar.mjs';
import InvalidFieldType from '../../../shared/InvalidFieldType.mjs';

import { deleteItem } from '../actions.mjs';

import { upcase } from '../../../../utils/string.mjs';

import { ASYNC_FIELD_LOADING, ASYNC_FIELD_LOADED } from '../constants.mjs';
...
const EditForm = createReactClass({
	...
	onAsyncFieldValuesLoaded (fieldName) {
		...
		const isLoadingComplete = Object.values(this.__asyncFields).filter(asyncStatus => asyncStatus !== ASYNC_FIELD_LOADED).length === 0;
		this.setState({
