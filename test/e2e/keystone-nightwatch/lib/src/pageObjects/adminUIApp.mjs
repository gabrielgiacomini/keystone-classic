...
export default self = {
	...
	commands: [{
		...
		waitForSigninScreen: function (config) {
			const _config = Object.assign({}, { timeout: this.api.globals.waitForConditionTimeout }, config);
		...
		getPrimaryNavbarSectionElement: function (config) {
			const label = utils.keyToLabel(config.section);
		...
		getSecondaryNavbarListElement: function (config) {
			const path = utils.keyToPath(config.list, true);
