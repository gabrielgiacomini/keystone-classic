 ...
 * @property {boolean|string} [createdAt=false] - The path to store the creation timestamp.
 * @property {boolean|string} [createdBy=false] - The path to store the user who created the document.
 * @property {boolean|string} [updatedAt=false] - The path to store the update timestamp.
 * @property {boolean|string} [updatedBy=false] - The path to store the user who last updated the document.
 */
 ...
 *
 * @param {keystone.List} list The list to add the tracking behavior to.
 * @api public
 */
