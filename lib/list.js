...
module.exports = function (keystone) {
	 ...
	 * @param {string} [options.path] - The path for the list.
	 * @param {Object} [options.schema] - The schema for the list.
	 * @param {boolean} [options.noedit] - Whether to disable editing of items in the Admin UI.
	 * @param {boolean} [options.nocreate] - Whether to disable creating new items in the Admin UI.
	 * @param {boolean} [options.nodelete] - Whether to disable deleting items in the Admin UI.
	 * @param {boolean} [options.autocreate] - Whether to automatically create a new item when the list is empty.
	 * @param {boolean} [options.sortable] - Whether to enable sorting of items in the Admin UI.
	 * @param {boolean} [options.hidden] - Whether to hide the list in the Admin UI.
	 * @param {boolean} [options.track] - Whether to track creation and modification of items.
	 * @param {boolean} [options.inherits] - Whether the list inherits from another list.
	 * @param {number} [options.perPage] - The number of items to display per page in the Admin UI.
	 * @param {string} [options.searchFields] - The fields to search when a search query is submitted.
	 * @param {boolean} [options.searchUsesTextIndex] - Whether to use a text index for searching.
	 * @param {string} [options.defaultSort] - The default sort field for the list.
	 * @param {string} [options.defaultColumns] - The default columns to display in the list view.
	 * @constructor
	 */
	 ...
	 * @see module:lib/list/expandPaths
	 */
	 ...
	 * @see module:lib/list/expandColumns
	 */
