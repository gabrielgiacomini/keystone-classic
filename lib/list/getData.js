 ...
 *
 * @param {import('mongoose').Document} item The Keystone item to get data from.
 * @param {string|string[]} [fields] The fields to include in the returned data.
 * @param {boolean} [expandRelationshipFields=false] Whether to expand relationship fields.
 * @return {{id: string, name: string, fields: Object.<string, any>}} The processed data object.
 */
