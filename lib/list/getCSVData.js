 ...
 *
 * @param {import('../../fields/types/Type')} field The field to transform.
 * @param {import('mongoose').Document} item The item to get the value from.
 * @param {{fields: string[]|string, expandRelationshipFields: boolean}} options The options for the transformation.
 ...
 *
 * @param {import('mongoose').Document} item The item to get the data from.
 * @param {{fields: string[]|string, expandRelationshipFields: boolean}} options The options for getting the data.
 * @return {Object.<string, any>} The data ready for CSV serialization.
 */
