 ...
 *
 * @param {import('../field').Field} field The field to transform.
 ...
 * @param {string|string[]} [options.fields] The fields to include.
 * @param {boolean} [options.expandRelationshipFields=false] Whether to expand relationship fields.
