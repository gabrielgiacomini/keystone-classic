/**
 * @fileoverview This file defines the `register` function, which registers a
 * Keystone list with Mongoose and Keystone. It applies schema plugins, adds
 * default fields and virtuals, and sets up model events.
 */
...
function register () {
	...
	// Add a virtual to the schema to access the list
	...
	// Add underscore methods to the schema
	...
	// Add a method to the schema to get an update handler
