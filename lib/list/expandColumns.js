 ...
 *
 * @param {string|string[]} cols The columns to expand.
 * @return {{field: import('../field').Field, path: string, type: string, label: string, refList?: import('./list'), refPath?: string, subField?: import('../field').Field, populate?: {path: string, subpath: string}, width?: string, isName?: boolean}[]} The expanded columns.
 */
