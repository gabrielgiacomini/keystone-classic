 ...
 * @return {{rawInput: string, isDefaultSort: boolean, input: string, paths: {field: import('../../fields/types/Type'), invert: boolean, path: string}[], string: string}} The expanded sort object.
 */
