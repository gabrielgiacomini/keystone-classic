 ...
 *
 * @type {String}
 * @property {function} get - A getter function for the `name` property.
 */
 ...
 *
 * @param {Object} fields - An object where keys are field paths and values are field options.
 * @returns {Page} The Page instance, to allow for method chaining.
 * @api public
 */
 ...
 *
 * @returns {Page} The registered Page instance.
 * @api public
 * @example
