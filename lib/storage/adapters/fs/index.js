 ...
 * @param {string} options.fs.path
 * @param {string} options.fs.publicPath
 * @param {function} options.fs.generateFilename
 * @param {string} options.fs.whenExists
 * @param {number} options.fs.retryAttempts
 * @param {Object} schema
 * @constructor
 */
