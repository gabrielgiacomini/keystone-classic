/**
 * @fileoverview Implements the main `Storage` class for Keystone, which manages
 * file storage and adapters. This class is responsible for initializing and
 * validating storage adapters, defining the storage schema, and providing a
 * consistent API for file uploads and removals.
 *
 * It acts as a bridge between Keystone's field types and the underlying storage
 * adapters (e.g., FS, S3, Azure), ensuring that adapters are compatible and
 ...
 * @requires debug
 * @see module:lib/storage/adapters/fs/index
 */
 ...
 *
 * @param {Object} options - The options for the storage instance.
 * @param {function} options.adapter - The storage adapter to use.
 * @param {Object} [options.schema] - The schema for the storage instance.
 * @constructor
 */
 ...
 *
 * @param {Object} file - The file object.
 * @param {Object} schema - The storage schema.
 * @param {function(Error, Object): void} callback - The callback function.
 * @private
 */
 ...
 * @param {function(Error, Object): void} callback - The callback to call when the upload is complete.
 * @api public
 */
 ...
 *
 * @param {Object} value - The field value containing the file information.
 * @param {function(Error): void} callback - The callback to call when the file is removed.
 * @api public
 */
