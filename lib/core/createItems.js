/**
 * @fileoverview This file defines the `createItems` method for the Keystone instance.
 * It is used to create multiple items in one or more Lists, and is a powerful tool for seeding and importing data.
 * @module lib/core/createItems
 */
 ...
 * @returns {boolean} `true` if the value is a valid MongoDB ObjectId, otherwise `false`.
 * @private
 */
 ...
 *
 * @param {object} data An object where keys are List keys and values are arrays of item data to create.
 * @param {object} [ops] Options for the creation process.
 * @param {boolean} [ops.verbose=false] If `true`, logs verbose output to the console.
 * @param {boolean} [ops.strict=true] If `true`, stops the process on the first error.
 * @param {object} [ops.refs=null] An object to store references to the created items.
