/**
 * @fileoverview This file defines the `Email` class, a wrapper around the
 * `keystone-email` package that provides a simplified and integrated way to
* send emails from a Keystone application.
 *
 * The `Email` class handles the configuration and instantiation of email
 * templates, and ensures backward compatibility with older Keystone versions.
 * It uses Keystone's configuration options to set up the email transport and
 * templating engine, making it easy to send transactional emails.
 *
 * @module lib/email
 * @requires keystone
 * @requires keystone-utils
 * @requires ./safeRequire
 * @see module:lib/safeRequire
 */
 ...
 * Email constructor.
 *
 * @param {Object|string} options - The options for the email, or a template name.
 * @constructor
 * @api public
 */
