/**
 * @fileoverview This file implements the update application system for Keystone.
 * It is responsible for discovering, validating, and applying application updates
 * in a sequential and controlled manner. Updates are typically used for data
 * migrations, and this module ensures they are applied only once and in the
 * correct order.
 *
 * The system uses a dedicated MongoDB collection (`app_updates`) to track which
 * updates have been applied. It supports deferred and background updates, and
 * provides clear logging of the update process.
 *
 * @module lib/updates
 * @requires lodash
 * @requires async
 ...
 * Applies the updates.
 *
 * @param {function} callback - The callback to call when the updates are applied.
 * @api public
 */
exports.apply = function (callback) {
	 ...
	 *
	 * @param {string} file - The update file to apply.
	 * @param {function} done - The callback to call when the update is applied.
	 * @private
	 */
