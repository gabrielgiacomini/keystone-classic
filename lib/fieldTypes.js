/**
 * @fileoverview This file serves as a central registry for all available field
 * types in Keystone. It uses getters to lazy-load each field type, which improves
 * startup performance by only loading the field types that are actually used.
 *
 * Each getter corresponds to a specific field type and returns the constructor
 * for that type. This allows developers to easily extend Keystone with custom
 * field types by adding them to this file.
 *
 * @module lib/fieldTypes
 * @see module:lib/list
 */
var fields = {
