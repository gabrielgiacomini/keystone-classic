 ...
 * @see module:admin/server/api/item/sortOrder
 * @see module:admin/server/api/item/update
 * @see module:admin/server/api/list/create
 * @see module.admin/server/api/list/delete
 * @see module:admin/server/api/list/update
 * @see module:admin/server/api/session/signin
 * @see module:admin/server/api/session/signout
 * @see module:admin/server/routes/index
 * @see module:admin/server/routes/signin
 */
